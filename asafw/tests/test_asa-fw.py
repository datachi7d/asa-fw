...
# header_1 = [
#     asa_field1(field=1, length=2, data=b'\x01\x01'),
#     asa_field1(field=2, length=4, data=b'\x00\x00\x01\x8c'),
#     asa_field1(field=3, length=113, data=[
#         asa_field1(field=4, length=48, data=b'CN=CiscoSystems;OU=NCS_Kenton_ASA;O=CiscoSystems'),
#         asa_field1(field=5, length=8, data=b'5AB844ED'),
#         asa_field1(field=6, length=48, data=b'CN=CiscoSystems;OU=NCS_Kenton_ASA;O=CiscoSystems')]),
#     asa_field1(field=7, length=1, data=b'\x00'),
#     asa_field1(field=8, length=1, data=b'\x01'),
#     asa_field1(field=9, length=1, data=b'\x00'),
#     asa_field1(field=10, length=1, data=b'\x01'),
#     asa_field1(field=11, length=256, data=b"C\x9e]3c4\xac\xb3\xdb\x84\xdcw;\x18\xe4\xde\xbdx\x0f\x12y\x8c\xfaKy\xb5\xbb\x12&\xd5'\x1c\x05\x98\x05O\xc1\x9d|\xdes\xcfT\xb3J\xce<J\x83{\x8f\xbe\x83\x1c\xcf\xbc\xfc\xd7\xb0. \xa7Z\xbb\x1fD\xab\xd3_\x98\t2%\xa8\x95\x98+\x91d\xbf\xf0\xaf\x88(\xa7\xb0\xa6<~\x10\xa18o-\xd9\xf5\x84\xd1\xc3\x85\xb3\xeb,\x90\x16\x82\xb1,G\x8a\xf2\x8e#9\x7f\xed\xef7\x93'\xbcsn\x80\xddu\xf7\x9d!\x18N\t\x19\xf4O{\x1cj\xdbb{\xd8=1\xfe\x0c\xe4\x1a?\x8bg\x1c\xc5dE.\x8d\x99\xb4\x99\x06\xa1%\xb5\x03{\x0c\xbdm\xbfl^\xc1TD\xc3&b\xc8\x8epB\xa0\t\xeeM\xa1\x05\xc45\x08<\xe7\xc3}\xa2[cWz5\xabR\xc3\xe1\x9b\xf2J\xd3\x98W\xc3\xef\xe1:\n\x81\xd3\xe5\xd7\x1a\xfdGM\x1a\xe7O\xd8\x92_\xd0\xf7*\x1c\xe2\x99\xc6\xc7]f&U\xc0{U\x91\x91\xb5\xeb\x13\xed\xfd\xcd\xa7\xd9\xb5"),
#     asa_field1(field=12, length=1, data=b'A')]
